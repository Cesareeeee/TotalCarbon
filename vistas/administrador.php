...
if ($_SESSION['id_rol'] != 1) { // Asumiendo que 1 es el ID de administrador
...
<head>
    ...
    <title>Página Administrador - Total Carbon</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="#">
                <i class="fas fa-crown me-2"></i>Total Carbon Admin
            </a>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="welcome-card">
                    <i class="fas fa-crown fa-4x mb-4" style="color: #ff6b6b;"></i>
                    <h1 class="display-4 fw-bold mb-3">PÁGINA ADMINISTRADOR</h1>
                    <p class="lead">Panel de control administrativo de Total Carbon</p>
